...
//        super(context, R.style.dialog_center); //dialog的样式
        super(context, R.style.DialogTransparent); //dialog的样式
     ...
     * 根据资源id获取控件
     */
    public TextView getTextView(int layoutResID) {
        TextView textView = findViewById(layoutResID);
        if (textView != null) {
            return textView;
        }
    ...
    public void setTextDrawableTop(int layoutResID, int resId) {
        ...
        if (textView != null) {
            ...
            textView.setCompoundDrawablePadding(MyAppUtil.dp2px(context, 8));
        }
    }
