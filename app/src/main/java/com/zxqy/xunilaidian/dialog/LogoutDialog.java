...
public class LogoutDialog extends AlertDialog implements View.OnClickListener {
    ...
    public interface OnCenterItemClickListener {
        void OnCenterItemClick(LogoutDialog dialog, View view);
    }
    ...
    public LogoutDialog(Context context, int layoutResID, int[] listenedItems, boolean isEdit) {
     ...
     * 设置点击状态
     */
    public void setEnabled(int layoutResID, boolean enabled) {
        TextView textView = findViewById(layoutResID);
        if (textView != null) {
